...
data-source add \
  ...
  --driver-name=mysql \
  --connection-url="jdbc:mysql://\${env.NIORDDB_PORT_3306_TCP_ADDR:localhost}:\${env.NIORDDB_PORT_3306_TCP_PORT:3306}/\${env.NIORDDB_DATABASE:niord}?useSSL=true&requireSSL=false&characterEncoding=latin1_swedish_ci" \
